...
export async function renderConfirmationEmail(data: NotificationData): Promise<string> {
...
export async function renderCancellationEmail(
  ...
  return render(<AppointmentCancellation data={data} cancelledBy={cancelledBy} />);
}